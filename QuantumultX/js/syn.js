function operator(proxies) {
    ...
    let udp = true
    sortProxies.unshift({name: '🇱🇺 LU 硝酸二甲酯 0.01x', type, server: "traffic-in-01.811920.xyz", port: 50009, cipher, password, udp})
    sortProxies.unshift({name: '🇸🇬 SG 苯巴比妥钠 0.01x', type, server: "traffic-in-01.811920.xyz", port: 50012, cipher, password, udp})
    sortProxies.unshift({name: '🇭🇰 HK 丁香酰氧胺 0.01x', type, server: "traffic-in-02.811920.xyz", port: 50013, cipher, password, udp})

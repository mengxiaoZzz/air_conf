function operator(proxies) {
    ...
    sortProxies.unshift({name: '🇸🇬 TG 碳酸二甲酯', type, server: "traffic-in-a.811920.xyz", port: 54001, cipher, password, udp})
    sortProxies.unshift({name: '🇲🇴 TK 澳士蛋白酶 3x', type, server: "traffic-in-a.811920.xyz", port: 54001, cipher, password, udp})
    sortProxies.unshift({name: '🇯🇵 TK 日库木糖醇 3x', type, server: "traffic-in-a.811920.xyz", port: 54001, cipher, password, udp})
    //sortProxies.unshift({name: '🇺🇸 TK 美罗培南素 3x', type, server: "traffic-in-a.811920.xyz", port: 54001, cipher, password, udp})
